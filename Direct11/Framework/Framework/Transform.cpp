...
void Transform::RotationDegree(Vector3* vec) const
{
	Vector3 temp;
...
{
	return {bufferDesc.World._31, bufferDesc.World._32, bufferDesc.World._33};
}

Vector3 Transform::Up()
{
	return {bufferDesc.World._21, bufferDesc.World._22, bufferDesc.World._23};
}

Vector3 Transform::Right()
{
	return {bufferDesc.World._11, bufferDesc.World._12, bufferDesc.World._13};
}
